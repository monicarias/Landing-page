      ...
      <main>
          ...
          <div class="mx-auto max-w-7xl lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8">
              <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                <div class="lg:py-24">
                  <a href="https://landingpagemarcablanca.netlify.app/?#" class="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                  ...
                  <div class="mt-10 sm:mt-12">
                    <form action="https://landingpagemarcablanca.netlify.app/?#" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                      <div class="sm:flex">
                      ...
                      <p class="mt-3 text-sm text-gray-300 sm:mt-4">Te contactaremos en 24 horas. Aceptamos todas las tarjetas de crédito y débito. <a href="https://landingpagemarcablanca.netlify.app/?#" class="font-medium text-white">Conoce nuestros términos y condiciones</a>.</p>
                    </form>
                  </div>
                </div>
              </div>
              <div class="mt-12 -mb-16 sm:-mb-48 lg:m-0 lg:relative">
                <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
                  ...
                  <img class="w-full lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none" src="./U Guitars_files/photo-1511379938547-c1f69419868d" alt="">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="mt-12 mx-auto max-w-md px-4 grid gap-8 sm:max-w-lg sm:px-6 lg:px-8 lg:grid-cols-3 lg:max-w-7xl">
              <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                <div class="flex-shrink-0">
                  <img class="h-48 w-full object-cover" src="./U Guitars_files/photo-1617160895032-11179689e7b5" alt="">
                </div>
                <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                  <div class="flex-1">
                    <p class="text-sm font-medium text-cyan-600">
                      <a href="https://landingpagemarcablanca.netlify.app/?#" class="hover:underline">
                        Nueva
                      </a>
                    </p>
                    <a href="https://landingpagemarcablanca.netlify.app/?#" class="block mt-2">
                  ...
                  <div class="mt-6 flex items-center">
                    <div class="flex-shrink-0">
                      <a href="https://landingpagemarcablanca.netlify.app/?#">
                        <img class="h-10 w-10 rounded-full" src="./U Guitars_files/photo-1472099645785-5658abf4ff4e" alt="Roel Aufderehar">
                      </a>
                    </div>
                    <div class="ml-3">
              ...
              <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                <div class="flex-shrink-0">
                  <img class="h-48 w-full object-cover" src="./U Guitars_files/photo-1583385788355-6cc226732695" alt="">
                </div>
                <div class="flex-1 bg-white p-6 flex flex-col justify-between">
                  <div class="flex-1">
                    <p class="text-sm font-medium text-cyan-600">
                  ...
                  <div class="mt-6 flex items-center">
                    <div class="flex-shrink-0">
                      <a href="https://landingpagemarcablanca.netlify.app/?#">
                        <img class="h-10 w-10 rounded-full" src="./U Guitars_files/photo-1550291652-6ea9114a47b1" alt="Roel Aufderehar">
                      </a>
                    </div>
                    <div class="ml-3">
                      <p class="text-sm font-medium text-gray-900">
        ...
        <div class="relative bg-gray-900">
          <div class="relative h-56 bg-indigo-600 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
            <img class="w-full h-full object-cover" src="./U Guitars_files/photo-1598517511269-fd89417b561c" alt="">
          ...
          <div class="relative mx-auto max-w-md px-4 py-12 sm:max-w-7xl sm:px-6 sm:py-20 md:py-28 lg:px-8 lg:py-32">
            <div class="md:ml-auto md:w-1/2 md:pl-10">
              ...
              <p class="mt-2 text-white text-3xl font-extrabold tracking-tight sm:text-4xl">
                Cuéntanos tus objetivos y podemos ayudarte a alcanzar ese nivel que buscas.
              </p>
              ...
              <div class="mt-8">
                <div class="inline-flex rounded-md shadow">
                  <a href="https://landingpagemarcablanca.netlify.app/?#" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">
                    Contactar ya mismo
          ...
          <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8 xl:col-span-1">
              <div class="flex space-x-6">
                <a href="https://landingpagemarcablanca.netlify.app/?#" class="text-gray-400 hover:text-gray-500">
              ...
              <div class="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul class="mt-4 space-y-4">
                    <li>
                      <a href="https://landingpagemarcablanca.netlify.app/?#" class="text-base text-gray-500 hover:text-gray-900">
                        Catálogo
                      </a>
                    </li>
                  </ul>
